...
},{"./View":12,"../converters/DateConverter":9}],8:[function(require,module,exports) {
"use strict";
...
var NegotiationController = /** @class */function () {
    ...
    NegotiationController.prototype._createNegotiation = function () {
        return new Negotiation_1.Negotiation(DateConverter_1.DateConverter.toDate(this._inputDate.value), parseInt(this._inputQuantity.value), parseFloat(this._inputValue.value));
    };
    return NegotiationController;
}();
exports.NegotiationController = NegotiationController;
},{"./../domain/negotiation/Negotiations":6,"../ui/views/NegotiationsView":7,"./../domain/negotiation/Negotiation":8,"./../ui/converters/DateConverter":9,"./../ui/models/Message":10,"../ui/views/MessageView":11}],2:[function(require,module,exports) {
"use strict";
...
},{"./controllers/NegotiationController":5}],16:[function(require,module,exports) {
...
//# sourceMappingURL=/app.b67aa344.map